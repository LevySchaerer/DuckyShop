		...
		<div className={styles.body}>
			<div className={styles.container}>
				<h1 className={styles.pageTitle}>
					<span className="shineText" />
					Premium Rubber Ducks
				</h1>
				<h5 className={styles.pageSubTitle}>
					Discover the world's finest collection of luxury rubber ducks
				</h5>

				<div className={styles.sliderWrapper}>
					<div
						className={styles.slider}
						style={{ transform: `translateX(${calculateSliderDiff(index)}px)` }}
					>
					...
					<div
						className={`${styles.addToCartError} ${addToCartError ? styles.show : ''}`}
					>
						{addToCartError}
					</div>
					<IoIosArrowBack
