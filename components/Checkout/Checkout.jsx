			...
			<div className={styles.checkoutContainer}>
				...
				<div className={styles.rightSection}>
					...
					<h3 className={styles.totalPrice}>
						Total: <span>{sum.toFixed(1)}0 Fr</span>
					</h3>

					<div className={styles.paymentSection}>
						<p className={styles.paymentInfo}>
							<FaInfo className={styles.infoIcon} />
							Please do not change the amount in the App, otherwise the order cannot
							be delivered.
						</p>
						<button className={styles.twintButton} onClick={validateForm}>
							<img
								className={styles.twintImage}
