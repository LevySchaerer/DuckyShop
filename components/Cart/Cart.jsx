...
const Cart = ({ isOpen, onClose }) => {
	...
	useEffect(() => {
		...
		setCart(cartjson);
		const amountSum = cartjson.reduce(
	...
	return (
		<div className={styles.cartOverlay} onClick={onClose}>
			...
			>
				...
				<Link onClick={onClose} href="/checkout" className={styles.checkoutButton}>
					<TbTruckDelivery size={30} className={styles.checkoutIcon} />
					<span className={styles.chackoutText}>Checkout</span>
				</Link>
			</div>
		</div>
	);
