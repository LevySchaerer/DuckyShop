        ...
        <div className={styles.container}>
            ...
            <div className={styles.person2}>
                <div className={styles.profileContainer}>
                    ...
                    <div className={styles.profilePoints}><FaCode size={25}/> Frontend Developer</div>
                    <div className={styles.profilePoints}><FaAccessibleIcon size={25}/> Full Stack Lega</div>
                    <div className={styles.profilePoints}><GiFullPizza size={25}/> Fake italian</div>
                    <div className={styles.profilePoints}><LuCarrot size={25}/> Carrots are underrated</div>
                </div>
                <div className={styles.ImageContainer}>
            ...
            <div className={styles.person3}>
                ...
                <div className={styles.profileContainer}>
                    ...
                    <div className={styles.profilePoints}><VscAzure size={25}/> Cloud Specialist</div>
                    <div className={styles.profilePoints}><PiBoxingGlove size={25}/> 19 Years of Boxing experience</div>
                    <div className={styles.profilePoints}><FaMapLocationDot size={25}/> Proud Serb</div>
                    <div className={styles.profilePoints}><FaBaby size={25}/> Family father of three children</div>
                </div>
            </div>
